...
void walk(int *x, int *y){
    ...
    switch (rand()%6){
        ...
        case 4: (sx = xplus1(sx),sy = yplus1(sy));break;
        case 5: (sx = xminus1(sx), sy = yminus1(sy));break;
    }
    *x = sx;
    *y = sy;
}
...
int done(mat A, int x, int y){
    int flag;
    flag = A[yminus1(y)][x] + A[y][xplus1(x)] + A[yplus1(y)][xplus1(x)] + A[yplus1(y)][x] + A[y][xminus1(x)] + A[yminus1(y)][xminus1(x)];
    return flag;
}
