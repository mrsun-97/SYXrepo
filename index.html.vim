...
<body>
	<div id="home" class="header">
				...
				<div class="top-nav">
					<ul class="nav">
						...
						<li class="dropdown1"><a href="#">Sample Page</a>
							<ul class="dropdown2">						//这个dropdown2如果不需要的话就取消吧
		...
		<div class="header-bottom">
			<!-- container -->
			<div class="container">
				<div class="head-logo">									<!-- headlogo 和 logoright 应该是要换成物理学院logo -->
...
<!-- comment -->									<ul class="dropdown2">
										...
										<li class="dropdown1"><a href="fullwidth.html">Celebrity News<span>Juicy Hollywood Gossip</span></a>
<!-- comment -->									<ul class="dropdown2">
												<li><a href="lifestyle.html">Blog Page</a></li>
												<li><a href="archives.html">Archive Page</a></li>
												<li><a href="fullwidth.html">Full Width Page</a></li>
...
<!-- comment -->									<ul class="dropdown2">
										...
										<li class="dropdown1"><a href="fullwidth.html">Entertainment<span>Movies, Music & Reviews</span></a>
<!-- comment -->									<ul class="dropdown2">
												<li><a href="lifestyle.html">Blog Page</a></li>
												<li><a href="archives.html">Archive Page</a></li>
												<li><a href="fullwidth.html">Full Width Page</a></li>
...
<!-- comment -->									<ul class="dropdown2">
							...
							<div class="banner-middle">
								...
								<div class="slider">					
									...
									<!-- Slideshow 3 Pager -->
									<ul id="slider3-pager">					<!-- 缩略图 -->
									  <li><a href="#"><img src="images/1c.jpg" alt=""></a></li>
									  <li><a href="#"><img src="images/2c.jpg" alt=""></a></li>
									  <li><a href="#"><img src="images/3c.jpg" alt=""></a></li>
									  <li><a href="#"><img src="images/4c.jpg" alt=""></a></li>
									  <li><a href="#"><img src="images/5c.jpg" alt=""></a></li>
									  <li><a href="#"><img src="images/6c.jpg" alt=""></a></li>
									</ul>
								</div>
	...
	<div class="footer">
		<!-- container -->
		<div class="container">
			<div class="footer-grids">							//坐标好像需要调整
